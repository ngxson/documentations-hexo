...
function Hexo(base = process.cwd(), args = {}) {
  ...
  this.public_dir = join(base, 'documentations', 'public') + sep;
  this.source_dir = join(base, 'documentations', 'source') + sep;
  this.plugin_dir = join(base, 'node_modules') + sep;
  this.script_dir = join(base, 'documentations', 'scripts') + sep;
  this.scaffold_dir = join(base, 'documentations', 'scaffolds') + sep;
  this.theme_dir = join(base, 'documentations', 'theme') + sep;
